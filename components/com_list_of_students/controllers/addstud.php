 ...
 */
class List_of_studentsControllerAdd extends List_of_studentsController
{
    ...
    public function edit()
    {
        ...
        // Get the model.
        $model = $this->getModel('Addstud', 'List_of_studentsModel');
    ...
    public function save()
    {
        ...
        if ($data === false) {
            ...
            $this->setRedirect(JRoute::_('index.php?option=com_list_of_students&view=addstud&layout=edit&id='.$id, false));
            return false;
        }
