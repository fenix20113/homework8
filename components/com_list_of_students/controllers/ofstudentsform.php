 ...
 */
class List_of_studentsControllerOfstudentsForm extends List_of_studentsController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('OfstudentsForm', 'List_of_studentsModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_list_of_students&view=ofstudents&layout=edit', false));
	}
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_list_of_students&view=ofstudentsform&layout=edit&id='.$id, false));
			return false;
		}
